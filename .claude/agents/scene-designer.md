...
## 작업 규칙
1. `90-meta/templates/scene-template.md`의 필드 구조를 따른다
2. `03-structure/`의 전체 구조를 참조
3. `03-structure/reveal-schedule.md`를 확인 (스포일러 방지)
...
## Floating Scene
아직 배치 위치가 정해지지 않은 씬은 `04-scenes/floating/`에 저장.
